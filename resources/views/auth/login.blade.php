...
@section('contenido')
    <div class="md:flex md:justify-center md:gap-10 md:items-center">
        <div class="md:w-6/12 p-5">
            <img src="{{asset('img/login.jpg')}}" alt="Imagen login de usuarios" class="">
        </div>
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            <form method="POST" action="{{route('login')}}" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <label for="remember" class="text-gray-500 text-sm cursor-pointer">Mantener mi sesión abierta</label>
                </div>
